...
from domains.base import Point, Segment, BoundaryShape
...
class CompositeDomain(BoundaryShape):
    ...
    def __init__(self,
        ...
        """
        Parámetros:
        - domains: lista de subdominios (e.g., cuadriláteros)
        - connections: líneas de conexión iniciales
        - spacing: separación por defecto entre puntos
        """
    ...
    # -------------------------------
    def add_connection(self, p1: Point, p2: Point, spacing: float = 1.0):
        ...
        n_points = max(2, int(np.ceil(d / spacing)))
