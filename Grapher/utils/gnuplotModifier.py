...
def simple_script_gnuplot(ruta_archivo_base, lim=3000, retardo=0.001, nombre_salida="plot_animacion.gp"):
    ...
    # ====================================================================
    # 🔥 DETECCIÓN DE RANGOS CONSECUTIVOS POR TIPO
    # ====================================================================
    grupos = []
    inicio = 0
    tipo_actual = tipos[0]
    ...
    # ====================================================================
    # 🔥 CONSTRUCCIÓN DEL BLOQUE PLOT, dejando el último sin ",\"
    # ====================================================================
    plot_lines = []
    primera = True
...
do for [i=0:lim]{{
  ...
  pause retardo
    ...
    print(f"✅ Script Gnuplot generado correctamente: {nombre_salida}")
